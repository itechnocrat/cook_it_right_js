...
Это структура сценария для будущего видео, но видео будет не скоро, а структурой возможно пользоваться уже сейчас.  
    ...
    - Data Structures (Структуры данных)  
        - Objects (Объекты)  
            ...
            - Парадигма Прототипно-Ориентированного Программирования (JavaScript)  
                - Литералы объектов  
                - Свойства  
                    - Примитивный тип данных Symbol, как имя свойств  
                    - Вычислимые свойства  
                - Методы  
                    - функции, как методы  
                    - set  
